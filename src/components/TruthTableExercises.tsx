...
interface TruthTableExerciseProps {
    truthTableAnswers: { not_x3: string; x2_OR_notx3: string; x1_AND_x2: string; y: string }[];
    handleTruthTableInput: (rowIndex: number, column: keyof { not_x3: string; x2_OR_notx3: string; x1_AND_x2: string; y: string }, value: string) => void;
    showTruthTableResults: boolean;
}

const TruthTableExercises: React.FC<TruthTableExerciseProps> = ({ truthTableAnswers, handleTruthTableInput, showTruthTableResults }) => {
