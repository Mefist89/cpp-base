...
interface Programul1ExerciseProps {
  variants: ProgramulExerciseVariant[];
}

const Programul1Exercise: React.FC<Programul1ExerciseProps> = ({ variants }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="mb-6 md:mb-8">
        <h2 className="text-2xl md:text-4xl font-bold text-center text-blue-900 mb-4">Program 1 - Exerciții</h2>
        <VariantButtons
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 md:p-8 space-y-6">
        ...
        <div className="border-b pb-6">
          <div className="flex items-start gap-3">
            <Code size={28} className="text-blue-600 flex-shrink-0 mt-1" />
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 md:p-6 border border-blue-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="bg-white border-2 border-blue-300 rounded px-3 md:px-4 py-2 md:py-3 font-mono text-sm md:text-base bg-gray-50">
...
export default Programul1Exercise;
