...
interface Programul2ExerciseProps {
  variants: ProgramulExerciseVariant[];
}

const Programul2Exercise: React.FC<Programul2ExerciseProps> = ({ variants }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="mb-6 md:mb-8">
        <h2 className="text-2xl md:text-4xl font-bold text-center text-blue-900 mb-4">Program 2 - Exerciții</h2>
        <VariantButtons
...
export default Programul2Exercise;
