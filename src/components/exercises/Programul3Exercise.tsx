...
interface Programul3ExerciseProps {
  variants: ProgramulExerciseVariant[];
}

const Programul3Exercise: React.FC<Programul3ExerciseProps> = ({ variants }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="mb-6 md:mb-8">
        <h2 className="text-2xl md:text-4xl font-bold text-center text-green-900 mb-4">Program 3 - Exerciții</h2>
        <VariantButtons
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 md:p-8 space-y-6">
        ...
        <div className="border-b pb-6">
          <div className="flex items-start gap-3">
            <Code size={28} className="text-green-600 flex-shrink-0 mt-1" />
        ...
        {/* Example */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 md:p-6 border border-green-200">
...
export default Programul3Exercise;
